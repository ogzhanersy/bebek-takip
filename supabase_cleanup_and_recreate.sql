-- =============================================
-- Baby Tracker Flutter - Supabase Database Cleanup and Recreate
-- =============================================
...
DROP TRIGGER IF EXISTS update_diaper_records_updated_at ON diaper_records;
...
DROP FUNCTION IF EXISTS get_active_sleep(UUID);
DROP FUNCTION IF EXISTS get_active_feeding(UUID);
DROP FUNCTION IF EXISTS get_today_records(UUID, DATE);
...
-- =============================================
-- 2. RECREATE ALL TABLES AND FUNCTIONS
-- =============================================
